    ...
    <div className="min-h-screen bg-[#181E2F] text-slate-100 flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="app-card p-8">
          ...
          <p className="text-sm text-slate-300 mb-6">Accede a tu cuenta para ver los partidos.</p>
          ...
          <div className="mt-4 text-sm text-slate-300 flex justify-between">
            <Link to="/forgot-password" className="text-cyan-300 hover:underline">
              ¿Olvidaste tu contraseña?
            </Link>
            <Link to="/verify-email" className="text-cyan-300 hover:underline">
              Verificar email
            </Link>
          </div>
        </div>
